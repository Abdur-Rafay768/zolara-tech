                        ...
                        <div className="row gx-0 align-items-center">
                              ...
                              <div className="tp-header-hamburger-btn offcanvas-open-btn" 
                               ...
                               onClick={() => setSidebarOpen(true)}>
                                 ...
                                 <div className="tp-header-logo">
                                    <Link href="/">
                                       <Image src={Logo} alt="theme-pure" width={150} height={80}/>
                                    </Link>
                                 </div>
                              </div>
                              </div>
                           ...
                           <div className="tp-header-main-right d-flex align-items-center justify-content-xl-end">
                                 <div className="tp-header-btn d-none d-xl-block pl-40">
                                    <a className="tp-btn" style={{padding: '21px 16px'}} href="tel:+18633208528">+1 (863) 268-5598<br /> 9 am - 6 pm Eastern Time, Mon - Sat</a>
                                 </div>
                              </div>
                           </div>
                        </div>
