                     ...
                     <div className="row">
                        ...
                        <div className="col-lg-12">
                           <div className="tp-service-title-wrapper text-center">
                              <h3 className="tp-section-title">All Professional <i>Solutions</i> & Services
                                 ...
                                 <SplideSlide key={i}>
                                       <div className="tp-service-wrapper p-relative mb-55">
                                          ...
                                          <div className="tp-service-btn">
                                             <Link href="/internet">Read Out More 
                     ...
                     <div className="row">
                        <div className="col-lg-12">
                           <div className="tp-service-all-btn text-center fadeUp">
                              <Link className="tp-btn" href="/aboutus">View all Services</Link>
                           </div>
                        </div>
                     </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                           <div className="tp-fun-fact-content">
                              <div className="tp-fun-fact-title-wrapper">
                                 <h3 className="tp-section-title">What makes zolora.tech different?
                                    <span className="title-left-shape"> 
                                    <LineArrowTwo />
                                    </span>
                                 </h3>
                                 <p>
                                 Discover service providers effortlessly. Enter your zip code to access a comprehensive list of internet, TV, and phone providers. Stay updated with our real-time data
                                 </p>
                                 <ul>
                                    <li>
                                 ...
                                 <div className="tp-fun-fact-btn">
                                    <Link className="tp-btn" href="mailto:@admin@zolara.tech">Tell us How Can We Help</Link>
                                 </div>
                              </div>
                           </div>
                        </div>
