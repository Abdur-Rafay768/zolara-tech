    ...
    <Wrapper>
      ...
      <div style={{ width: "70%", margin: "20vh auto", textAlign: "left" }}>
        ...
        >
          ...
          owned by Zolara Tech LLC and may not be reproduced without our prior
          consent.
        </p>
        ...
        >
          In order to provide additional information or services, Zolara Tech
          LLC may include links to external websites. Clicking on such a link
          will navigate you away from the Digital Marketing Agencies site. The
          inclusion of links does not necessarily imply a recommendation, nor
          does it in any way endorse the views expressed within them. Other
          site’s Terms and Conditions may differ from our own. When clicking off
          the Zolara Tech LLC site, we strongly encourage you to visit the other
          site’s Terms and Conditions to ensure it meets the standards of your
        ...
        >
          In no event will Zolara Tech LLC be held liable for any loss or damage
          of information including but not limited to indirect or consequential
          loss or damage, loss or damage of data, or profits arising out of or
          in connection with the use of this website.  Zolara Tech LLC may not be
          held liable or responsible in any way for loss or damage that may
          result to you or a third party as a result of your use of our website.
        </p>
        <p
          style={{
            fontWeight: "400",
